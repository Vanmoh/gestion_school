          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 10,
                children: [
                  Indicateur(libelle: 'Encaissements', valeur: '${periodPayments.length}'),
                  Indicateur(libelle: 'Mode dominant', valeur: dominantMethodLabel),
                  Indicateur(libelle: 'Frais impayés', valeur: '${outstandingFees.length}'),
                  Indicateur(libelle: 'Montant affiché', valeur: _formatMoney(totalPaid)),
                ],
              ),
