...
part 'teachers_assignments_dialog.dart';
part 'teachers_management_dialog.dart';
part 'teachers_account_dialog.dart';
part 'teachers_profile_dialog.dart';
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          // La liste imprimable porte les coordonnees de chaque agent:
          // elle suit le meme droit que les autres exports nominatifs.
