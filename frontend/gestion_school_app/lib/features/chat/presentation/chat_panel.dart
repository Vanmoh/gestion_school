...
class _ChatPanelState extends State<ChatPanel> {
  ...
  /// Qui peut faire surgir une fenetre chez quelqu'un d'autre.
  ///
  /// La liste des roles vivait ici en clair, sous un commentaire qui
  /// demandait de la tenir alignee sur une constante du serveur -- alignement
  /// que rien ne verifiait. Elle vient desormais de la matrice.
  ///
  /// Ce panneau n'est pas un widget Riverpod: il passe donc par le relais
  /// prevu pour les appelants hors de l'arbre, celui dont se sert deja
  /// l'intercepteur reseau. Le serveur reste seul juge -- il refuse
  /// l'action -- mais proposer un bouton qui mene a un refus ne vaut rien.
  bool get _peutAppelerAttention =>
      ModulePermissionsRegistry.current.can(Capacites.appelAttention);
